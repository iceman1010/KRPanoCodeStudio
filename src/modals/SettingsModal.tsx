...
export function SettingsModal({ open, onOpenChange }: SettingsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl md:max-w-3xl lg:max-w-4xl">
        ...
        <div className="-mx-4 min-h-0 flex-1 overflow-y-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div className="rounded-lg border p-3 space-y-2">
              <Label htmlFor="apikey" className="text-xs font-medium uppercase tracking-wide text-muted-foreground">API key</Label>
            ...
            {/* Model */}
            <div className="rounded-lg border p-3 space-y-2">
              <Label className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Default model</Label>
              <Select
                value={selectedModel ?? ""}
            ...
            {/* Backup retention */}
            <div className="rounded-lg border p-3 space-y-2">
              <Label htmlFor="backup" className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Backup retention</Label>
              <Input
                id="backup"
                type="number"
                min={1}
            ...
            {/* CLI idle timeout */}
            <div className="rounded-lg border p-3 space-y-2">
              <Label htmlFor="cliIdleTimeout" className="text-xs font-medium uppercase tracking-wide text-muted-foreground">CLI idle timeout</Label>
              ...
              <p className="text-[11px] text-muted-foreground">
                Minutes before the app warns a CLI call is idle (5 min
            ...
            {/* Theme */}
            <div className="rounded-lg border p-3 space-y-2">
              <Label className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Theme</Label>
            ...
            {/* Behavior toggles */}
            <div className="rounded-lg border p-3 space-y-2">
              <span className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Behavior</span>
              <div className="flex items-center gap-2">
                <Checkbox
                  id="reasoning"
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="autoApproveFileScope" className="cursor-pointer text-sm font-normal">
                  Auto-approve file scope plan
                </Label>
              </div>
              <p className="text-[10px] text-muted-foreground">
                When enabled, the AI's proposed file list is auto-approved
                without asking. Use with caution — you won't see which files
                the model plans to read before it reads them.
              </p>
            </div>

            {/* ---- Update row: App + CLI side by side ---- */}
            <div className="col-span-full grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="rounded-lg border p-3 space-y-2">
                ...
                <p className="text-[11px] leading-relaxed text-muted-foreground">
                  This is the app you are looking at right now — the window with
                  the tour preview and the buttons. When a new version is
                  released, a banner appears at the top of the window to install
                  it.
                </p>
              ...
              <div className="rounded-lg border p-3 space-y-2">
                ...
                <p className="text-[11px] leading-relaxed text-muted-foreground">
                  This is the helper program that does the actual work behind
                  the scenes — it reads your tour files and makes the edits. It
                  has no window of its own. Use the buttons below to update it.
                </p>
                {backendInfo && (
